...
class TemplateCollector():
    def __init__(self, save_folder) -> None:
        ...
        self.pybullet_object_path = 'self.pybullet_object_path = './pybullet-URDF-models/urdf_models/models'/pybullet-URDF-models/urdf_models/models'
